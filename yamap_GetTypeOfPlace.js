...
function getMAP(temp){
	...
	// https://geocode-maps.yandex.ru/1.x/?apikey=YOUR_KEY&geocode=55°01%2715.0%22N%2082°57%2721.9%22E&format=json",function(data) {
	x=x.concat("N");
...
//           
	...
	// $.get("https://geocode-maps.yandex.ru/1.x/?apikey=YOUR_KEY&geocode=&format=json?" 
	return way; 
}
